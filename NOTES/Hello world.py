...
#octothorp lol this is octothorp- # <-more like tic tac toe XD

print(" this is sum programimg 1 thingie")
print("AGHHAHAHGAGAHHA we usal are exprirncing the tecnoacl isue")
